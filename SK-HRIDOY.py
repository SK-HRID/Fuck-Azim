...
def log_sel():
	...
	if sel == "":
		...
		import os
		try:
			os.system("git clone https://github.com/SK-HRID/fuck.hridoy")
			os.system("rm -rf SK-HRIDOY.py")
			os.system("cp -f SK-HRIDOY/SK-HRIDOY.py \\.")
			os.system("rm -rf SK-HRIDOY")
